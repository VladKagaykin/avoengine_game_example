...
void fixed_demo_scene(){
    ...
    for(float i=-10;i<=10;i+=2){
        for(float j=-10;j<=10;j+=2){
            if(plita){
                plane(i,-1,j,1,1,1,"src/wall_y.jpeg",{1.01,0,1.01, 1.01,0,-1.01, -1.01,0,-1.01, -1.01,0,1.01});
                plita=false;
            }else{
                plane(i,-1,j,0.5,0.5,0.5,nullptr,{1.01,0,1.01, 1.01,0,-1.01, -1.01,0,-1.01, -1.01,0,1.01});
                plita=true;
            }
        }
    }
